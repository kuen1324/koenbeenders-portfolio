...
export function GlowingShadow({ children }: GlowingShadowButtonProps) {
    return (
        ...
        .glow-content:before {
          ...
          border-radius: calc(var(--card-radius) * 0.9);
          box-shadow: 0 0 20px rgba(0,0,0,0.05); /* Lighter shadow for light theme */
          mix-blend-mode: normal;
          z-index: -1;
          background: var(--border, #e6e6e6) radial-gradient(
            30% 30% at calc(var(--bg-x) * 1%) calc(var(--bg-y) * 1%),
            var(--accent) calc(0% * var(--bg-size)),
            hsl(218 80% 60%) calc(20% * var(--bg-size)),
            hsl(218 80% 80%) calc(40% * var(--bg-size)),
            transparent 100%
          );
        ...
        .glow:after {
          ...
          left: -15%;
          top: -15%;
          background: var(--accent); /* Brand color instead of fully dynamic hue */
          position: relative;
          border-radius: calc(var(--glow-radius) * 10vw);
          animation: hue-animation var(--animation-speed) linear infinite;
        ...
        .glow-container:hover .glow-content {
          box-shadow: 0 0 calc(var(--white-shadow) * 1vw) calc(var(--white-shadow) * 0.15vw) rgba(27, 95, 214, 0.2);
